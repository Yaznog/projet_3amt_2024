...
module rr_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [91:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [17:0] pio_s1_agent_m0_address;                                                            // pio_s1_agent:m0_address -> pio_s1_translator:uav_address
	...
	wire  [92:0] pio_s1_agent_rf_source_data;                                                        // pio_s1_agent:rf_source_data -> pio_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] pio_s1_agent_rsp_fifo_out_data;                                                     // pio_s1_agent_rsp_fifo:out_data -> pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pio_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pio_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pio_s1_agent:cp_endofpacket
	...
	wire  [91:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [91:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire         pio_s1_agent_rp_valid;                                                              // pio_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] pio_s1_agent_rp_data;                                                               // pio_s1_agent:rp_data -> router_005:sink_data
	wire         pio_s1_agent_rp_ready;                                                              // router_005:sink_ready -> pio_s1_agent:rp_ready
	wire         pio_s1_agent_rp_startofpacket;                                                      // pio_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pio_s1_agent_rp_endofpacket;                                                        // pio_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         pio_s1_agent_rdata_fifo_src_valid;                                                  // pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pio_s1_agent_rdata_fifo_src_data;                                                   // pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pio_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_003:in_0_ready -> pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> pio_s1_agent:rdata_fifo_sink_error
	...
	rr_mm_interconnect_0_router router (
	...
	rr_mm_interconnect_0_router router_001 (
	...
	rr_mm_interconnect_0_router_002 router_002 (
	...
	rr_mm_interconnect_0_router_002 router_003 (
	...
	rr_mm_interconnect_0_router_002 router_004 (
	...
	rr_mm_interconnect_0_router_002 router_005 (
	...
	rr_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	rr_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
